#!/usr/bin/env node
/* Regenerate assets/drive-taitung.webm.b64.js from assets/drive-taitung.webm.
 *
 ...
 *
 * Run this whenever assets/drive-taitung.webm changes. build.js then inlines the
...
const WEBM = path.join(HERE, 'assets', 'drive-taitung.webm');
const OUT  = path.join(HERE, 'assets', 'drive-taitung.webm.b64.js');

if (!fs.existsSync(WEBM)) { console.error('missing', WEBM); process.exit(1); }
const b64 = fs.readFileSync(WEBM).toString('base64');

const js =
`/* GENERATED from assets/drive-taitung.webm — do not edit by hand.
